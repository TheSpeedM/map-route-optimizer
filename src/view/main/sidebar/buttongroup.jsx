    ...
    <div className="py-3 mx-3">
      <div className="flex justify-between items-center mb-2">
        ...
        <button className="text-gray-700" onClick={toggleCollapsed}>
          {collapsed ?
            <Icon icon={'solar:alt-arrow-down-outline'} className="ml-2 w-6 h-6" /> :
            <Icon icon={'solar:alt-arrow-up-outline'} className="ml-2 w-6 h-6" />}
        </button>
      </div>
...
export const AlgorithmWithInputs = ({ title, inputs, onClick, startCollapsed = false }) => {
